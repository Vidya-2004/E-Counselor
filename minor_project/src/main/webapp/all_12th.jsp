    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="text-center mb-20">
                <h1 class="sm:text-3xl text-2xl font-medium text-center title-font text-gray-900 mb-4">12th Courses
                </h1>
            ...
            <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                <div class="p-2 sm:w-1/2 w-full animate-fade-slide" style="animation-delay: 0.1s">
                    <div class="bg-gray-100 rounded-2xl border-2 border-indigo-500 hover:bg-indigo-100 shadow-lg transition-transform transform hover:scale-105 flex p-4 h-full items-center">
                        ...
                        <a href="<%= request.getContextPath() %>all_intermediate_courses.jsp" class="myLink"><span
                                class="title-font font-medium text-lg text-gray-800">Science</span></a>
                    </div>
                </div>
                ...
                <div class="p-2 sm:w-1/2 w-full animate-fade-slide" style="animation-delay: 0.1s">
                    <div class="bg-gray-100 rounded-2xl border-2 border-indigo-500 hover:bg-indigo-100 shadow-lg transition-transform transform hover:scale-105 flex p-4 h-full items-center">
                        ...
                        <a href="<%= request.getContextPath() %>all_intermediate_courses.jsp" class="myLink"><span
                                class="title-font font-medium text-lg text-gray-800">Commerce</span></a>
                    </div>
                </div>
                ...
                <div class="p-2 sm:w-1/2 w-full animate-fade-slide" style="animation-delay: 0.1s">
                    <div class="bg-gray-100 rounded-2xl border-2 border-indigo-500 hover:bg-indigo-100 shadow-lg transition-transform transform hover:scale-105 flex p-4 h-full items-center">
                        ...
                        <a href="<%= request.getContextPath() %>all_intermediate_courses.jsp" class="myLink"><span
                                class="title-font font-medium text-lg text-gray-800">Arts/Humanities</span></a>
                    </div>
                </div>
