...
<body class="bg-gray-100">
  ...
  <header class="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
    ...
    <section class="max-w-6xl mx-auto my-8 p-6 bg-white shadow-md rounded-lg" id="criteria_list">
        ...
        <h1 class="text-4xl font-bold text-gray-800 mb-4 text-center">Eligibility Criteria</h1>
        <!--  -->
        <ul class="font-medium" id="criteria_eligibility"></ul>
    </section>
    ...
    <script src="<%= request.getContextPath() %>/JS/all_intermediate_courses.js"></script>
</body>
