...
<head>
  ...
  <title>All PG Courses</title>
  <link rel="stylesheet" href="<%= request.getContextPath() %>/css/all_pg_courses.css">
...
<body class="bg-gray-100">
  ...
  <script src="<%= request.getContextPath() %>/JS/all_pg_courses.js"></script>
</body>
