...
<body class="bg-gradient-to-r from-blue-300 via-teal-300 to-indigo-200 text-black font-bold">
	<div class="flex flex-col md:flex-row min-h-screen">
		...
		<main class="flex-1 p-6 bg-gradient-to-br from-teal-400 to-blue-300 rounded-l-lg shadow-2xl">
			...
			<header
				...
				<div class="text-lg font-bold">View Feedback</div>
						...
						<tbody>
							...
							<tr class="border-b">
								...
								<td class="py-2 px-4 text-center">
									<button
										class="bg-red-500 text-white py-1 px-2 rounded hover:bg-red-700">Delete</button>
								</td>
							</tr>
	...
	<script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            console.log('View Feedback Page Loaded');
        });
    </script>
</body>
